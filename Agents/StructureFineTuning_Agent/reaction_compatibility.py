...
from StructureFineTuning_Agent.functional_groups import analyze_functional_groups, has_functional_group, suggest_functional_group_addition, suggest_functional_group_removal
