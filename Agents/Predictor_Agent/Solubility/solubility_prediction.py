...
def load_model_and_featurizer():
    with open('Agents/Predictor_Agent/Solubility/saved_models/model_info.pkl', 'rb') as f:
    ...
    model.restore(model_dir='Agents/Predictor_Agent/Solubility/saved_models')
...
def load_model_and_featurizer_esol():
    with open('Agents/Predictor_Agent/Solubility/deepchem_ESOL/saved_models/model_info.pkl', 'rb') as f:
        model_info = pickle.load(f)
    ...
    model.restore(model_dir='Agents/Predictor_Agent/Solubility/deepchem_ESOL/saved_models')
