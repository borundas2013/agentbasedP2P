from StructureFineTuning.structurefinetune import remove_bond_by_smarts, add_group_by_smarts
...
def remove_bond_by_smarts_tool(smiles1: str, smiles2: str, bond_smarts: str, target_monomer: str = "1") -> str:
    return remove_bond_by_smarts(smiles1, smiles2, bond_smarts, target_monomer)

def add_group_by_smarts_tool(smiles1: str, smiles2: str, group_smarts: str, target_monomer: str = "1", attachment_atom_idx: int = 0) -> str:
